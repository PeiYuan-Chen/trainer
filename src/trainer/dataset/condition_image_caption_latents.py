...
class StreamingConditionImageCaptionLatentsDataset(StreamingDataset):
    def __init__(
        self,
        batch_size: int,
        ...
        cond_image_latent_key: str = "cond_image_latents",
        cond_image_latent_dtype: torch.dtype = torch.bfloat16,
        ...
        **streaming_kwargs,
        ...
        self.cond_image_latent_key = cond_image_latent_key
        self.cond_image_latent_dtype = cond_image_latent_dtype
    ...
    def __getitem__(self, index: int) -> dict[str, Any]:
        ...
        out[self.cond_image_latent_key] = numpy_to_tensor(
            sample[self.cond_image_latent_key],
            self.cond_image_latent_dtype,
        )
